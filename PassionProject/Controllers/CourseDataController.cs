...
namespace PassionProject.Controllers
{
    public class CourseDataController : ApiController
    {
        ...
        /// <summary>
        /// Removes an association between a particular course and a particular student
        /// </summary>
        ...
        /// </returns>
        /// <example>
        /// POST api/CourseData/RemoveStudent/9/1
        /// </example>
        [HttpPost]
        [Route("api/CourseData/RemoveStudent/{courseid}/{studentid}")]
        public IHttpActionResult RemoveStudent(int courseid, int studentid)
        {

            Course SelectedCourse = db.Courses.Include(a => a.Students).Where(a => a.CourseId == courseid).FirstOrDefault();
        ...
        [HttpPost]
        [Route("api/CourseData/associateStudent/{courseid}/{studentid}")]
        [Authorize]
        public IHttpActionResult associateStudent(int courseid, int studentid)
        {

            Course SelectedCourse = db.Courses.Include(c => c.Students).Where(c => c.CourseId == courseid).FirstOrDefault();
            Student SelectedStudent = db.Students.Find(studentid);
