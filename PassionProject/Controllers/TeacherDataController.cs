...
namespace PassionProject.Controllers
{
    public class TeacherDataController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/TeacherData/dropcoursetaught/{teacherid}/{courseid}")]
        public IHttpActionResult dropcoursetaught(int teacherid, int courseid)
        {
            Teacher SelectedTeacher = db.Teachers.Include(a => a.Courses).Where(a => a.TeacherID == teacherid).FirstOrDefault();
            ...
            Debug.WriteLine("input student id is: " + teacherid);
